...
if __name__ == "__main__":
    ...
    conn_params= pika.ConnectionParameters(AMQP_SERVER, port=AMQP_PORT, virtual_host="/", credentials=creds_broker)
    ...
    while True:
        try:
            ...
            channel.exchange_declare( exchange="cluster_test",exchange_type="direct",auto_delete=False)
            ...
            channel.basic_consume(on_message_callback=msg_rcvd, queue="cluster_test", auto_ack=False, consumer_tag="cluster_test")
